...
## 📁 Project Structure
```text
├── index.html        # Main landing and showcase hub
├── pages/
│   └── calculator.html  # Interactive calculation tool view
├── JS/
│   └── calculator.js    # Computational operations and UI logic
└── public/           # Global visual assets and styles
```

## 🎯 Assessment Goals Met
1. **Directory Control:** Correct deployment via GitHub Pages leveraging clean asset mapping.
2. **Component Integration:** Asynchronous or linked page flows without dead endpoints.
3. **Problem Solving:** Refactoring file routing and case-sensitive paths for seamless static file hosting.
